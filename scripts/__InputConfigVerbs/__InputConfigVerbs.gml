function __InputConfigVerbs()
{
    ...
    if (not INPUT_ON_SWITCH)
    {
        ...
        InputDefineVerb(INPUT_VERB.CHOICE1, "choice1", ord("1"), undefined);
        InputDefineVerb(INPUT_VERB.CHOICE2, "choice2", ord("2"), undefined);
        InputDefineVerb(INPUT_VERB.CHOICE3, "choice3", ord("3"), undefined);
    }
